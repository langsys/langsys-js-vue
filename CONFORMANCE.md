...
1. **GATE-7 coverage for persistent layouts.** A header/nav/footer calling `t()` does not
...
2. **BIND-6 — 14 pure pass-through wrappers.** `LangsysAppVue` re-implements 14 core methods that
